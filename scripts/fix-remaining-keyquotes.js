...
for (const file of files) {
  ...
  // Only process files needing Key Quotes
  if (!sourceContent.includes('## Summary') || !sourceContent.includes('## Key Points') || sourceContent.includes('## Key Quotes')) {
    continue;
  }
