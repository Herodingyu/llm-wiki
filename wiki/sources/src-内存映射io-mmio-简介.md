...
- "MMIO places I/O devices in memory space rather than I/O space, allowing CPU to access devices using the same instructions as memory access."
- "PortIO does not occupy CPU physical address space, while MMIO does."
