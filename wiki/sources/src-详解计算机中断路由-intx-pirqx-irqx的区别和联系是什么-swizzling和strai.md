...
- Source: [原始文章](raw/tech/peripheral/详解计算机中断路由：INTx、PIRQx、IRQx的区别和联系是什么？Swizzling和Straight又是什么？PIC和APIC路由表怎么解读？.md)
...
- [原始文章](raw/tech/peripheral/详解计算机中断路由：INTx、PIRQx、IRQx的区别和联系是什么？Swizzling和Straight又是什么？PIC和APIC路由表怎么解读？.md)
