---
title: "设备驱动之 UIO 机制"
source: "https://zhuanlan.zhihu.com/p/555333046"
author:
  - "[[DPDK原理]]"
published:
created: 2026-05-02
description: "一个设备驱动的主要任务有两个： 1. 存取设备的内存 2. 处理设备产生的中断对于第一个任务。UIO 核心实现了mmap()能够处理物理内存(physical memory)，逻辑内存(logical memory)， 虚拟内存(virtual memory)。UIO…"
tags:
  - "clippings"
---
2 人赞同了该文章
...
对于第一个任务。 [UIO](https://zhida.zhihu.com/search?content_id=211540182&content_type=Article&match_order=1&q=UIO&zhida_source=entity) 核心实现了 [mmap()](https://zhida.zhihu.com/search?content_id=211540182&content_type=Article&match_order=1&q=mmap%28%29&zhida_source=entity) 能够处理物理内存(physical memory)，逻辑内存(logical memory)，  
[虚拟内存](https://zhida.zhihu.com/search?content_id=211540182&content_type=Article&match_order=1&q=%E8%99%9A%E6%8B%9F%E5%86%85%E5%AD%98&zhida_source=entity) (virtual memory)。UIO驱动的编写是就不须要再考虑这些繁琐的细节。

第二个任务，对于设备中断的应答必须在 [内核空间](https://zhida.zhihu.com/search?content_id=211540182&content_type=Article&match_order=1&q=%E5%86%85%E6%A0%B8%E7%A9%BA%E9%97%B4&zhida_source=entity) 进行。所以在内核空间有一小部分代码 用来应答中断和禁止中断，可是其余的工作所有留给 [用户空间](https://zhida.zhihu.com/search?content_id=211540182&content_type=Article&match_order=1&q=%E7%94%A8%E6%88%B7%E7%A9%BA%E9%97%B4&zhida_source=entity) 处理。
...
![](https://pic1.zhimg.com/v2-95fb9905150523d9dc9136b1b5f4580a_1440w.jpg)
...
学习地址： [Dpdk/网络协议栈/vpp/OvS/DDos/NFV/虚拟化/高性能专家](https://link.zhihu.com/?target=https%3A//ke.qq.com/course/5066203%3FflowToken%3D1043717) (更多DPDK学习资料有需要的可以自行报名学习，免费订阅，永久学习）或者 [点击这里](https://link.zhihu.com/?target=https%3A//jq.qq.com/%3F_wv%3D1027%26k%3DKPK40DbF) 加Q群免费领取，关注我持续更新哦！！

![](https://pic1.zhimg.com/v2-92bad242ef00a266432a9fd4fae6e340_1440w.jpg)

> 相关视频推荐  
> [千万级并发的难点有哪些？（一）/网卡/协议栈/dpdk/源码/虚拟化/netmap/ovs](https://link.zhihu.com/?target=https%3A//www.bilibili.com/video/BV1kW4y1b7Rn%3Fshare_source%3Dcopy_web%26vd_source%3D264f91cd728c1d49d11183a22cdc52c4)  
> [探索用DPDK如何解决千万级流量并发（二）/虚拟网卡/KNI/spdk/源码/vpp/NFV](https://link.zhihu.com/?target=https%3A//www.bilibili.com/video/BV1Re4y1f74x%3Fshare_source%3Dcopy_web%26vd_source%3D264f91cd728c1d49d11183a22cdc52c4)

dpdk的uio实现的内核的代码主要在 [igb\_uio](https://zhida.zhihu.com/search?content_id=211540182&content_type=Article&match_order=1&q=igb_uio&zhida_source=entity).c中，整理一下主要的代码：
...
![](https://pic2.zhimg.com/v2-693fe25c802edda0df893de60f2c77d7_1440w.jpg)

编辑于 2022-08-20 14:11[小白初入模拟ic设计行业，如何快速学习?](https://www.zhihu.com/question/544023696/answer/2788291410)
